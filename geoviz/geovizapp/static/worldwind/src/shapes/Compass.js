...
/**
 * @exports Compass
 * @version $Id: Compass.js 2939 2015-03-30 16:50:49Z tgaskins $
 */
define([
        '../error/ArgumentError',
        '../util/Logger',
    ...
    function (ArgumentError,
        ...
        var Compass = function (screenOffset, imagePath) {
            ...
            var sOffset = screenOffset ? screenOffset
                ...
                //iPath = imagePath ? imagePath : WWUtil.currentUrlSansFilePart() + "/static/worldwind/images/notched-compass.png";
				iPath = imagePath ? imagePath : "/geoviz/static/worldwind/images/notched-compass.png";
